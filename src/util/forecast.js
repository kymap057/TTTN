...
module.exports = (latitude, longitude,language, callback) => {
    const key_api='2967e25e97c66f1a694641102be5f7b8';
    const url_wether = `https://api.openweathermap.org/data/2.5/find?lat=${latitude}&lon=${longitude}&appid=${key_api}&lang=${language}`;
